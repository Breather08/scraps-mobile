...
const PartnerCard: React.FC<PartnerCardProps> = ({
  ...
  const distanceInMiles = partner.distance
    ? (partner.distance * 0.621371).toFixed(1)
    : "0.6";
          ...
          <Image
            source={{
              uri:
                ...
                "https://images.pexels.com/photos/1855214/pexels-photo-1855214.jpeg?auto=compress&cs=tinysrgb&w=500",
            }}
            style={styles.image}
            resizeMode="cover"
          />
          ...
          <View style={styles.infoRow}>
            <View style={styles.collectionContainer}>
              ...
              <Text style={styles.collectionLabel}>
                Самовывоз {collectionTimeStart} - {collectionTimeEnd}
              </Text>
            </View>
